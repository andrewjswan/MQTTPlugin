@echo off
cls
Title Building MediaPortal MQTT Plugin (DEBUG)
cd ..
...
%MSBUILD_PATH% /target:Rebuild /property:Configuration=DEBUG /fl /flp:logfile=MQTTPlugin.log;verbosity=diagnostic MQTTPlugin.sln
